...
```shell
python3 sitemap2posts.py http://www.inforisktoday.com/ \
...
```shell
python3 sitemap2posts.py http://www.govinfosecurity.com/ \
    --sitemap_urls http://www.govinfosecurity.com/articles-sitemap1.xml http://www.govinfosecurity.com/articles-sitemap2.xml \
    --remove_404_records \
    --no-use-robots-txt \
