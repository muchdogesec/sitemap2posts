...
User can also use additional patterns to filter.
...
### Step 5: get post info

Finally the script should visit each URL to get the title, summary, tags and dates in the post.

We use a external python libraries specialised to do this.
...
```json
    {
        "url": "<POST URL>",
        "lastmod": "<SITEMAP TIME>",
        "sitemap": "<SITEMAP USED>",
        "modified_header": "<HTML MODIFIED>",
        "title": "<IDENTIFIED TITLE>",
        "meta_description": "<HTML META DESCRIPTION>",
        "authors": "<IDENTIFIED AUTHORS>",
        "tags": ["<IDENTIFIED TAGS>"],
        "htmldate": "<IDENTIFIED DATES>"
    },
```
